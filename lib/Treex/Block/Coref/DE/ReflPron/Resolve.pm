package Treex::Block::Coref::DE::ReflPron::Resolve;
use Moose;
use Treex::Core::Common;
extends 'Treex::Block::Coref::Resolve';
with 'Treex::Block::Coref::DE::ReflPron::Base';
...
override 'build_model_path' => sub {
    my $path = "/home/mnovak/projects/coref_projection/treex_cr_train/de/reflpron/tmp/ml/";
    # TRAIN AFTER PRONFIX
    #my $path = '/home/mnovak/projects/coref_projection/treex_cr_train/de/reflpron/tmp/ml/001_run_2017-01-26_18-35-40_17559.after_pronfix.train/001.8ba2e.mlmethod/model/train.official.table.gz.vw.ranking.model';
    # TRAIN-SMALL_DEV
    $path .= "002_run_2017-01-28_01-26-57_17550.on_train-small_dev/001.8ba2e.mlmethod/model/train-small_dev.official.table.gz.vw.ranking.model";
...
Treex::Block::Coref::DE::ReflPron::Resolve
