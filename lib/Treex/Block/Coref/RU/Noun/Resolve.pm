...
override 'build_model_path' => sub {
    my $path = '/home/mnovak/projects/coref_projection/treex_cr_train/ru/noun/tmp/ml/';
    # BEST TRAIN
    ...
    # TRAIN AFTER PRONFIX
    #my $path = '/home/mnovak/projects/coref_projection/treex_cr_train/ru/noun/tmp/ml/008_run_2017-01-26_23-34-10_17878.after_pronfix.train/001.8ba2e.mlmethod/model/train.official.table.gz.vw.ranking.model';
    # TRAIN-SMALL_DEV AFTER PRONFIX
    $path .= '009_run_2017-01-28_07-23-26_21405.on_train-small_dev/001.8ba2e.mlmethod/model/train-small_dev.official.table.gz.vw.ranking.model';
